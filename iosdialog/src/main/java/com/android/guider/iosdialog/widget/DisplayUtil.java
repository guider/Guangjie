package com.android.guider.iosdialog.widget;
...
public class DisplayUtil {
     ...
     *
     * @param activity 需要锁定的Activity
     * @param degree   旋转的角度。一般是通过{@link #getScreemRotation(Activity)}方法获得的数据
     */
